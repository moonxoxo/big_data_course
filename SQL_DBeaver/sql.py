...
conn = sqlite3.connect("../cinema-sql1.db")
cursor = conn.cursor()
...
# --- Query 3: Tasso di occupazione percentuale per sala ---
cursor.execute("""
...
# --- Query 3: Tasso di occupazione medio per sala ---
cursor.execute("""
...
print("\nTasso di occupazione medio per sala:")
for row in rows3:
    print(row)
